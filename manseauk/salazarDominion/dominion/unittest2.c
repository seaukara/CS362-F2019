...
int buyCount(struct gameState *pre, int currentPlayer) {
    int check;
    int choice = 1;
...
int checkEstateCount(struct gameState *pre, int currentPlayer)
{
    int check;
    int choice = 0;
    struct gameState post;
...
int main(int argc, char** argv)
{
    ...
    if (checkEstateCount(&game1, currentPlayer) == 0)
    {
    ...
    if (checkCoinCount(&game2, currentPlayer) == 0)
    {
    ...
    if (buyCount(&game2, currentPlayer) == 0)
    {
